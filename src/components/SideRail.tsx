...
import {
  MessageSquare, Phone, Globe, Info, Trophy, Tag, PenSquare, User,
...
const sidebarNavItems = [
  { id: "all", label: "All Discussions", icon: MessageSquare, to: "/" as const },
  { id: "contact", label: "Contact Us", icon: Phone, to: "/" as const },
  { id: "ads", label: "Advertisement", icon: Globe, to: "/" as const },
  { id: "about", label: "About Us", icon: Info, to: "/" as const },
  { id: "best", label: "Best Members", icon: Trophy, to: "/" as const },
  { id: "tags", label: "Tags", icon: Tag, to: "/" as const },
];
